        ...
        >
          {place.images[1] && (
            <button
              ...
              className={`${
                place.images.length > 3
                  ? "h-full w-[calc(50%-6px)] md:w-[calc(50%-8px)] lg:w-[calc(50%-12px)]"
                  : place.images.length === 3
                  ? "h-[calc(50%-6px)] w-full md:h-[calc(50%-8px)] lg:h-[calc(50%-12px)]"
                  : "h-full w-full"
              } `}
            >
              <Image
            ...
            >
              ...
              {place.images.length > 5 && (
                <>
                  ...
                  <p className="absolute right-1/2 top-1/2 z-20 -translate-y-1/2 translate-x-1/2 font-poppins text-4xl font-bold text-white">
                    {place.images.length - 5}+
                  </p>
                </>
              )}
